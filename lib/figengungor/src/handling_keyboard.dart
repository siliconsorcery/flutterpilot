...
class KeyboardExample extends StatelessWidget {
  ...
  final List<Example> _exampleList = [
    Example(
      title: "Closing",
      child: ClosingKeyboardPage(),
    ),
    Example(
      title: "Making Input Fields Visible When Focused Issue",
      child: MakingInputFieldsVisibleWhenFocusedIssuePage(),
    ),
    Example(
      title: "Making Input Fields Visible When Focused Solution",
      child: MakingInputFieldsVisibleWhenFocusedPage(),
    ),
  ];
