...
import 'package:dart/shopping/product.dart';
import 'package:dart/shopping/product_square_bloc.dart';

import 'package:flutter/material.dart';
import 'package:silicon/sorcery.dart';

// import 'package:color/color.dart' as IndieColor;
...
class _ProductSquareState extends State<ProductSquare> {
  ...
  Widget build(BuildContext context) {
    final productColor = Color(widget.product.color.hashCode | 0xFF000000);
    return Material(
      color: productColor,
      child: InkWell(
        onTap: widget.onTap,
